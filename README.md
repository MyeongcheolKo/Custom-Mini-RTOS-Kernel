...
A mini RTOS kernel for ARM Cortex-M built from scratch, targeting STM32F446xx (Cortex-M4), including bare-metal infrastructure (linker script, startup code) and peripheral drivers.
