...
A mini RTOS kernel for STM32F446xx (ARM Cortex-M4) built from scratch, including bare-metal infrastructure (linker script, startup code) and peripheral drivers.
