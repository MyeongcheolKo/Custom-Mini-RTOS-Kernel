...
void TIM1_UP_TIM9_IRQHandler(void)     __attribute__(( alias ("Default_Handler")));
...
void HDMI_CEC_IRQHandler(void)         __attribute__(( alias ("Default_Handler")));
void SPDIF_Rx_IRQHandler(void)         __attribute__(( alias ("Default_Handler")));
void FMPI2C1_IRQHandler(void)          __attribute__(( alias ("Default_Handler")));
void FMPI2C1_error_IRQHandler(void)    __attribute__(( alias ("Default_Handler")));
