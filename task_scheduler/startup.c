...
#define SRAM_SIZE (128 * 2024) // 128kb
...
void TIM1_UP_TIM9_Handler(void)     __attribute__(( alias ("Default_Handler")));
...
void FMC_Handler(void)              __attribute__(( alias ("Default_Handler")));        
...
void SAI1_Handler(void)             __attribute__(( alias ("Default_Handler")));
void SAI2_Handler(void)             __attribute__(( alias ("Default_Handler")));
void QuadSPI_Handler(void)          __attribute__(( alias ("Default_Handler")));
void HDMI_CEC_Handler(void)         __attribute__(( alias ("Default_Handler")));
void SPDIF_Rx_Handler(void)         __attribute__(( alias ("Default_Handler")));
void FMPI2C1_Handler(void)          __attribute__(( alias ("Default_Handler")));
void FMPI2C1_error_Handler(void)    __attribute__(( alias ("Default_Handler")));

uint32_t vetors[] __attribute__ ((section(".isr_vector"))) = {
    STACK_START,
